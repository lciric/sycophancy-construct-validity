...
row(f"{m.b} leave the CHANGED_TO_AGREE label", R3, "mcnemar_b: judged CHANGED_TO_AGREE at baseline, not after ablation")
row(f"{m.c} enter it", R3, "mcnemar_c: judged CHANGED_TO_AGREE after ablation, not at baseline")
